...
-------------------------------------------------------------------
-- Grand Inquisitor (id 6) - deliberately NOT linked from the
-- imperialnet index page. Reachable only by guessing/enumerating
-- /imperialnet/Grand-Inquisitor, e.g. after reading the "Inquisitors"
-- mention on /darkarchive. Rewards CTF{R3DS4B3R}.
-------------------------------------------------------------------
INSERT INTO Users (name, alias, summary) VALUES
("Grand Inquisitor", "Servant of the Inquisitorius | Jedi Hunter | Former Temple Guard", "I hunt what remains of the Jedi Order for the glory of the Empire. My identity is not listed on any public roster - if you are reading this, you found me the hard way.");

INSERT INTO JobDescriptions (user_id, title, description) VALUES
(6, "Grand Inquisitor of the Inquisitorius", "Leads the Inquisitors in tracking down surviving Jedi across the galaxy, reporting directly to Darth Vader.");
